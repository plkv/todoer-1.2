...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <span className="material-symbols-rounded ml-auto h-4 w-4">chevron_right</span>
  </ContextMenuPrimitive.SubTrigger>
))
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <ContextMenuPrimitive.ItemIndicator>
        <span className="material-symbols-rounded h-4 w-4">check</span>
      </ContextMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </ContextMenuPrimitive.CheckboxItem>
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
      <ContextMenuPrimitive.ItemIndicator>
        <span className="material-symbols-rounded h-2 w-2 fill-current">radio_button_checked</span>
      </ContextMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </ContextMenuPrimitive.RadioItem>
