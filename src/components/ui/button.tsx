...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-bg-bg-prim transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-accent-prim text-on-dark-content-prim hover:bg-accent-prim/90",
        destructive:
          "bg-accent-destructive text-on-dark-content-prim hover:bg-accent-destructive/90",
        outline:
          "border border-input bg-bg-prim hover:bg-accent-prim hover:text-on-dark-content-prim",
        secondary:
          "bg-fill-sec text-content-sec hover:bg-fill-sec/80",
        ghost: "hover:bg-accent-prim hover:text-on-dark-content-prim",
