...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-normal ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      ...
      size: {
        default: "h-10 px-4 py-2 [&_.material-symbols-rounded]:text-icon-sm",
        sm: "h-7 w-7 rounded-lg px-0 [&_.material-symbols-rounded]:text-base",
        lg: "h-11 rounded-md px-8 [&_.material-symbols-rounded]:text-icon-md",
        icon: "h-7 w-7 rounded-lg [&_.material-symbols-rounded]:text-base",
      },
    },
    defaultVariants: {
      variant: "default",
