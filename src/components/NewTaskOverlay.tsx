...
export const NewTaskOverlay = ({ open, onOpenChange, onSave }: NewTaskOverlayProps) => {
        ...
        >
          ...
          >
            <Textarea
              ...
              className="flex-1 p-0 min-h-0 bg-transparent resize-none focus-visible:ring-0 focus-visible:ring-offset-0"
              style={{
          ...
          >
            <Textarea
              ...
              className="self-stretch p-0 bg-transparent resize-none focus-visible:ring-0 focus-visible:ring-offset-0"
              style={{
                minHeight: '48px',
                color: colors.content.tertiary,
                fontFamily: '"SF Pro"',
